  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      <div className="max-w-[800px] w-full mx-auto px-4 md:px-6 pt-32 pb-16 md:pt-40 md:pb-24">
        <h1 className="text-3xl md:text-4xl font-display font-bold text-navy tracking-tight leading-tight mb-8">Datenschutzerklärung</h1>
        <div className="prose prose-sm text-slate-700 space-y-4">
          <p><strong>Stand: Juli 2026</strong></p>
          <h2 className="text-xl font-display font-bold text-navy mt-6">1. Verantwortlicher</h2>
          <p>DKK design&marketing<br />E-Mail: info.dkk@gmail.com</p>
          <h2 className="text-xl font-display font-bold text-navy mt-6">2. Erhebung und Speicherung personenbezogener Daten</h2>
          ...
          <h2 className="text-xl font-display font-bold text-navy mt-6">3. Kontaktformular</h2>
          ...
          <h2 className="text-xl font-display font-bold text-navy mt-6">4. Rechte der betroffenen Person</h2>
