        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <Reveal className="lg:col-span-5 space-y-8">
            <div>
              ...
              <p className="text-slate-600 text-sm mt-3 leading-relaxed">Senden Sie Ihre Anfrage oder Rohdaten für eine direkte technische Prüfung. Sie erhalten innerhalb von 12 Stunden eine direkte Antwort – keine Warteschleife, keine automatischen Antworten.</p>
            </div>

            <div className="bg-ink text-white border border-ink p-5">
            ...
            <div className="bg-white border border-slate-200 p-5">
              ...
              <p className="text-xs text-slate-800 mt-2">Lehnt Ihre Druckerei meine Datei ab, schreibe ich sie innerhalb von <strong>12 Stunden</strong> kostenfrei neu. In 12 Jahren ist das nie passiert.</p>
            </div>

            <div className="space-y-4 pt-2">
              <div className="flex items-start space-x-3">
                <div className="text-navy shrink-0"><Mail size={16} /></div>
                <div>
                  <span className="text-[10px] font-mono text-slate-500 uppercase block">DIREKTE E-MAIL</span>
              ...
              <div className="flex items-start space-x-3">
                <div className="text-navy shrink-0"><MapPin size={16} /></div>
                <div>
                  <span className="text-[10px] font-mono text-slate-500 uppercase block">STANDORT</span>
          ...
          <Reveal delay={1} className="lg:col-span-7 bg-white border border-slate-200 p-6 md:p-8">
            ...
            <ol className="mt-6 space-y-3 text-sm text-slate-700">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <span className="flex items-center justify-center w-6 h-6 bg-ink text-gold font-mono text-[10px] font-bold shrink-0">{i + 1}</span>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-8 px-6 py-3 bg-gold text-ink font-bold text-xs uppercase tracking-widest hover:bg-ink hover:text-white transition-all duration-200 group"
            >
